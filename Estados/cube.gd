...
func rotate_layer(axis: String, layer: int, clockwise: bool = true) -> void:
	if is_rotating:       # si el cubo ya está girando...
		return            # ignora imputs nuevos
	is_rotating = false   # debería ser true: nunca bloquea nuevas rotaciones, el cubo se rompe
